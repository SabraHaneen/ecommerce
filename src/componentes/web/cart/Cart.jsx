...
const incCount=async(productId)=>{

  const res=await incrementQuntity(productId);
...
{data?.products?(data.products.map((product)=>
  ...
  <div className="quantity">
    <button onClick={()=>decCount(product.productId)}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width={16}
        height={17}
    ...
    <button  onClick={()=>incCount(product.productId)}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width={16}
        height={17}
